...
<div class="container">
	<div class="row">
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 page-header text-left">
			<h1><?php echo (isset($titulo))? $titulo: "Administración - Editar tipo de herida"; ?></h1>
		</div>
	</div>
	<?php if(isset($url_editartipoherida, $tipoherida)): ?>
		<div class="row">
		...
		<div class="row">
			<div class="col-lg-8 col-lg-offset-2 col-md-8 col-md-offset-2  col-sm-8 col-sm-offset-2 col-xs-12 ">
				...
				<?php echo form_open_multipart($url_editartipoherida,$atributos); ?>
					...
					<div class="form-group">
						...
						<div class="col-lg-8">
							<?php $datos = array(
						        ...
						        'required'		=> 'required',
						        'autofocus'		=> 'autofocus',
						        'value' 		=> (isset($tipoherida->nombre_tipoherida))? $tipoherida->nombre_tipoherida: set_value('nombre'),
							);	?>
					...
					<div class="form-group">
						...
						<div class="col-lg-8">
							<?php $datos = array(
						        ...
						        'required'		=> 'required',
						        'class' 		=> 'form-control',
						        'value' 		=> (isset($tipoherida->descripcion_tipoherida))? $tipoherida->descripcion_tipoherida: set_value('descripcion'),
							);	?>
					...
					<div class="form-group">
						...
						<div class="col-lg-8">
							<img width='150' src="<?php echo asset_url('img/'.$tipoherida->imagen_tipoherida); ?>" alt="<?php echo $tipoherida->nombre_tipoherida; ?>" class="img-responsive" />
							<?php $datos = array(
						        'name'          => 'imagen',
						        'id'            => 'imagen',
