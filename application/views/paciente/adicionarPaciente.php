<?php 
/**
 * Vista adicionarPaciente, es la encargada de mostrar los campos necesarios para la adición de un nuevo paciente al usuario que ha iniciado sesión.
 *
...
<div class="container">
	<div class="row">
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 page-header text-left">
			<h1><?php echo (isset($titulo))? $titulo: "Adicionar paciente"; ?></h1>
		</div>
	</div>
	<?php if(isset($url_adicionarpaciente)): ?>
		<div class="row">
		...
		<div class="row">
			<div class="col-lg-8 col-lg-offset-2 col-md-8 col-md-offset-2  col-sm-8 col-sm-offset-2 col-xs-12 ">
				...
				<?php echo form_open($url_adicionarpaciente,$atributos); ?>
